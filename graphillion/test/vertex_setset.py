...
#         self.assertTrue(isinstance(vss, VertexSetSet))
#         self.assertEqual(
#             vss, VertexSetSet([g0, g1, g12, g123, g1234, g134, g14, g23, g34, g4]))
...
#         vss = VertexSetSet(u) & VertexSetSet(v)
#         self.assertTrue(isinstance(vss, VertexSetSet))
#         self.assertEqual(vss, VertexSetSet([g12, g14]))
...
#         vss = VertexSetSet(u) - VertexSetSet(v)
#         self.assertTrue(isinstance(vss, VertexSetSet))
#         self.assertEqual(vss, VertexSetSet([g0, g1, g123, g1234, g134, g4]))
...
#         vss = VertexSetSet(u) ^ VertexSetSet(v)
#         self.assertTrue(isinstance(vss, VertexSetSet))
#         self.assertEqual(vss, VertexSetSet([g0, g1, g123, g1234, g134, g23, g34, g4]))
...
#         vss = VertexSetSet(u) / VertexSetSet(v)
#         self.assertTrue(isinstance(vss, VertexSetSet))
#         self.assertEqual(vss, VertexSetSet([g0, g3, g34]))
...
#         vss = VertexSetSet(u) % VertexSetSet(v)
#         self.assertTrue(isinstance(vss, VertexSetSet))
#         self.assertEqual(vss, VertexSetSet([g0, g1, g134, g14, g4]))
...
#         self.assertEqual(vss, VertexSetSet([g0, g123, g1234, g2, g23, g234, g34, g4]))

#         v = [g12, g14, g23, g34]
#         vss = VertexSetSet(u).join(VertexSetSet(v))
#         self.assertTrue(isinstance(vss, VertexSetSet))
#         self.assertEqual(
#             vss, VertexSetSet([g12, g123, g124, g1234, g134, g14, g23, g234, g34]))

#         vss = VertexSetSet(u).meet(VertexSetSet(v))
#         self.assertTrue(isinstance(vss, VertexSetSet))
#         self.assertEqual(vss, VertexSetSet([g0, g1, g12, g14, g2, g23, g3, g34, g4]))

#         v = [g12, g14, g23, g34]
#         vss = VertexSetSet(u).subgraphs(VertexSetSet(v))
#         self.assertTrue(isinstance(vss, VertexSetSet))
#         self.assertEqual(vss, VertexSetSet([g0, g1, g12, g14, g4]))

#         vss = VertexSetSet(u).supergraphs(VertexSetSet(v))
#         self.assertTrue(isinstance(vss, VertexSetSet))
#         self.assertEqual(vss, VertexSetSet([g12, g123, g1234, g134, g14]))

#         vss = VertexSetSet(u).non_subgraphs(VertexSetSet(v))
#         self.assertTrue(isinstance(vss, VertexSetSet))
#         self.assertEqual(vss, VertexSetSet([g123, g1234, g134]))

#         vss = VertexSetSet(u).non_supergraphs(VertexSetSet(v))
#         self.assertTrue(isinstance(vss, VertexSetSet))
#         self.assertEqual(vss, VertexSetSet([g0, g1, g4]))

#         vss1 = VertexSetSet({}) - VertexSetSet([g1, g34])

#         vss2 = vss1.including(VertexSetSet([g1, g2]))
#         self.assertTrue(isinstance(vss2, VertexSetSet))
#         self.assertEqual(len(vss2), 11)

#         vss2 = vss1.including(g1)
#         self.assertTrue(isinstance(vss2, VertexSetSet))
#         self.assertEqual(len(vss2), 7)

#         vss2 = vss1.including((2,1))
#         self.assertTrue(isinstance(vss2, VertexSetSet))
#         self.assertEqual(len(vss2), 7)

#         vss2 = vss1.including(1)
#         self.assertTrue(isinstance(vss2, VertexSetSet))
#         self.assertEqual(len(vss2), 11)

#         self.assertRaises(KeyError, vss1.including, (1, 4))
#         self.assertRaises(KeyError, vss1.including, 5)

#         vss2 = vss1.excluding(VertexSetSet([g1, g2]))
#         self.assertTrue(isinstance(vss2, VertexSetSet))
#         self.assertEqual(len(vss2), 3)

#         vss2 = vss1.excluding(g1)
#         self.assertTrue(isinstance(vss2, VertexSetSet))
#         self.assertEqual(len(vss2), 7)

#         vss2 = vss1.excluding(e2)
#         self.assertTrue(isinstance(vss2, VertexSetSet))
#         self.assertEqual(len(vss2), 6)

#         vss2 = vss1.excluding(1)
#         self.assertTrue(isinstance(vss2, VertexSetSet))
#         self.assertEqual(len(vss2), 3)

#         self.assertRaises(KeyError, vss1.excluding, (1, 4))
...
#         vss = VertexSetSet(u).included(g12)
#         self.assertTrue(isinstance(vss, VertexSetSet))
#         self.assertEqual(vss, VertexSetSet([g0, g1, g12]))
