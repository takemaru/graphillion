...
class zdd {
 protected:
  static zdd_t node(elem_t e);  // TODO: rename to elem
  static zdd_t znull() { return zdd_t(-1); }
  ...
  static bool is_terminal(zdd_t f) { return f.Top() == 0; }
  static word_t node_id(zdd_t f) { return f.GetID(); }
  static elem_t var(zdd_t f) {  // TODO: rename to min_elem or min?
